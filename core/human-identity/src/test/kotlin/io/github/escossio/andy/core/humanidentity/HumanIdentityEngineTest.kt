...
class HumanIdentityEngineTest {
 @Test fun onlyBackendConfirmationValidates() { val e=HumanIdentityEngine(true); e.begin();e.challengeReceived();e.providerCredentialReceived();val reference=HumanIdentityReference("human-synthetic");assertEquals(HumanIdentityState.Validated(reference),e.backendValidated(reference)) }
