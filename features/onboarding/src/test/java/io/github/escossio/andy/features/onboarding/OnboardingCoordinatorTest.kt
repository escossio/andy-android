...
class OnboardingCoordinatorTest {
 ...
 private fun ok()=object:HumanAuthClient{override fun requestChallenge()=ChallengeResult.Success(challenge());override fun verify(challengeId:String,idToken:String)=VerifyResult.Success(HumanIdentityValidated("h"))}
}
