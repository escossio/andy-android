...
class AttentionRouterHumanAuthClientTest {
    ...
    @Test fun everyOfficialHumanAuthErrorIsMappedLiterally() {
    ...
    @Test fun missingEmptyAndMalformedSuccessBodiesFailClosed() {
    ...
    @Test fun incompatibleStatusAndUnexpectedResponseNeverAuthorize() {
    ...
    @Test fun networkFailureComesOnlyFromTransportException() {
        val failing = AttentionRouterHumanAuthClient("https://synthetic.invalid", object : HumanAuthTransport {
            override fun post(path: String, body: String): TransportResponse = throw IllegalStateException("synthetic")
        })
    ...
    private fun client(response: TransportResponse) = AttentionRouterHumanAuthClient("https://synthetic.invalid", object : HumanAuthTransport { override fun post(path: String, body: String) = response })
